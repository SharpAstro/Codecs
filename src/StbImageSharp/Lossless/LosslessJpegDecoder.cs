...
namespace StbImageSharp
{
    ...
    /// C# — does NOT reuse the Hebron-generated baseline JPEG code in
    /// <c>StbImage.Generated.Jpg.cs</c> because the lossless bitstream layout
    ...
    /// <see cref="ImageResult.FromMemory(byte[])"/> for baseline / progressive).
    ///
                ...
                switch (marker)
                {
                    ...
                    case SOF2:
                        throw new InvalidDataException(
                            $"SOF{marker - SOF0} is baseline/progressive JPEG — use ImageResult.FromStream instead of LosslessJpeg.FromStream");
