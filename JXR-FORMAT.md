...
| `YUV422` | colour, 4:2:2 (½ chroma) | 🚧 |
| `YUV420` | colour, 4:2:0 (¼ chroma) | 🚧 |
| `YUVK` | CMYK | ⬜ |
...
`SharpAstro.Jxr` decodes this today **if** it's 4:4:4; 4:2:0 / 4:2:2 is the in-progress
chroma work (the biggest remaining decode-robustness gap for arbitrary third-party files).
